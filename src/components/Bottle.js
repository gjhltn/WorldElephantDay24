...
<path className={`${styles.outline} ${fill===4 ? styles.fill : ''}`} d="M65.3,66.6c0.05,1.21,0.15,2.42,0.35,3.64c0.02,0.13,0.03,0.26,0.03,0.39
	...
	<path className={`${styles.teat} ${fill===4 ? styles.fill : ''}`} d="M65.66,60.52c0.02-0.13,0.03-0.26,0.03-0.39c0-2.75-4.81-5.13-11.73-6.23V13.51
	...
	<path className={fill===1 ? styles.fill : ''} d="M4.57,179.24v19.65v17.9c0,8.21,6.33,14.87,14.15,14.87h17.03h18.99h17.03
		c7.81,0,14.15-6.66,14.15-14.87v-17.9v-19.65H4.57z"/>
	<path className={fill===2 ? styles.fill : ''} d="M4.57,130.51v68.38v17.9c0,8.21,6.33,14.87,14.15,14.87h17.03h18.99h17.03
